...
public class MyTestListItemAdapter extends BaseAdapter {

    private List<TestListItem> items;
    private Context context;
    private int numItems = 0;

    public MyTestListItemAdapter(final List<TestListItem> items, Context context) {
        this.items = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TestListItem item = items.get(position);
